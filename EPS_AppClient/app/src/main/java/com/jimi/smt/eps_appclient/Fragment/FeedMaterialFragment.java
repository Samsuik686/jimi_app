                            ...
                            case R.id.edt_feed_material:
                                ...
                                if (scanValue.length() <= Constants.MATERIAL_LENGTH) {
                                    ...
                                    */
                                    ...
                                    lineseatList.add(bean.getScanlineseat());

                                    //更新visit、添加日志
                                    Operate operate = Operate.getOperateObj(globalData.getOperator(),Constants.FEEDMATERIAL,lineseatList,bean);
                                    mHttpUtils.mergeOperate(materialId,cycle,bean,operate,-1,null,null);
//                                    mHttpUtils.mergeOperate(bean,operate,-1,null,null);
