...
public class Constants {
    ...
    public static final long WRITE_TIMEOUT = 8000;
...
//    static final String urlBase = "http://10.10.11.90:8080/eps_server";
    //ip地址（公司测试）
    static final String urlBase = "http://183.236.111.164:6080/eps_server";
    //ip地址（生产）
//    static final String urlBase = "http://192.168.2.9:8080/eps_server";
    //公司外网
//    static final String urlBase = "http://120.198.40.186:28881/eps_server";
    //ip地址（贵州）
